...
Texture2D _TreeMask : register(t0); // R/G/B = 3 tree species
Texture2D _NatureMask : register(t1); // R=snow, G=river, B=reserved
Texture2D _GroundDiff : register(t2); // ground diffuse
Texture2D _GroundDisp : register(t3); // ground displacement
